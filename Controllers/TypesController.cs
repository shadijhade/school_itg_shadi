...
namespace school_itg_shadi.Controllers
{
    public class TypesController : Controller
    {
        ...
        public TypesController(school_shadiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Types != null ? 
                          ...
                          Problem("Entity set 'school_shadiContext.Types'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("TypeId,TypeDesc")] Type @type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TypeId,TypeDesc")] Type @type)
        {
            if (id != @type.TypeId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'school_shadiContext.Types'  is null.");
            }
            var @type = await _context.Types.FindAsync(id);
            if (@type != null)
            {
