...
namespace school_itg_shadi.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(school_shadiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classes != null ? 
                          ...
                          Problem("Entity set 'school_shadiContext.Classes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'school_shadiContext.Classes'  is null.");
            }
            var @class = await _context.Classes.FindAsync(id);
            if (@class != null)
            {
